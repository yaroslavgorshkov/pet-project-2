        ...
        <div className="flex flex-col gap-11xl">
            <div className="flex gap-12xl">
                <div
                    ...
                    className="testimonials-section__content pt-el-8xl flex overflow-auto gap-11xl -mx-overflow-container-sm md:-mx-overflow-container-md lg:-mx-overflow-container-lg xl:-mx-overflow-container-xl 2xl:mr-none px-el-sm md:px-el-md lg:px-el-3xl xl:px-el-10xl 2xl:pr-0"
                >
                    {dataList}
                </div>
